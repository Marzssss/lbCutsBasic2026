...
export function HoursLocationSection() {
    return (
        <section id="location" className="py-24 bg-white text-black">
            <Container>
                <div className="grid lg:grid-cols-2 gap-16 lg:gap-24">
                    {/* Info Side */}
                    <div className="flex flex-col justify-center">
                        <span className="label-text text-black/40 mb-8 block">Visit Us</span>
                        ...
                        <div className="space-y-12">
                            {/* Address */}
                            <div>
                                <h3 className="text-sm font-bold uppercase tracking-widest mb-4">Location</h3>
                    ...
                    {/* Map Side */}
                    <div className="relative h-[500px] lg:h-auto bg-neutral-100 grayscale hover:grayscale-0 transition-all duration-700">
                        <iframe
                            width="100%"
                            height="100%"
                            frameBorder="0"
