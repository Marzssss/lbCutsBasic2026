        ...
        <section className="relative min-h-[90vh] flex items-center pt-32 pb-20 overflow-hidden w-full max-w-[100vw]">
            ...
            <Container className="relative z-10 w-full grid lg:grid-cols-12 gap-8 lg:gap-8 items-center">
                ...
                <div className="col-span-12 lg:col-span-6 flex flex-col items-center lg:items-start text-center lg:text-left px-2 sm:px-0">
                    ...
                    <h1 className="text-4xl sm:text-5xl md:text-7xl lg:text-[5.5rem] leading-[0.95] font-bold tracking-[-0.03em] text-white mb-6 sm:mb-8 animate-fade-in-up delay-100">
                        Precision Cuts. <br />
                        <span className="font-display font-normal italic text-white/80">Tailored For You.</span>
                    </h1>

                    <p className="text-base sm:text-lg text-white/60 max-w-md leading-relaxed mb-8 sm:mb-10 animate-fade-in-up delay-200">
                    ...
                    <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 w-full sm:w-auto animate-fade-in-up delay-300">
                        <a
                            href="#booking"
                            className="bg-white text-black px-6 sm:px-8 py-3 sm:py-4 rounded-full font-medium tracking-wide hover:bg-gray-200 transition-colors duration-300 text-center text-sm sm:text-base"
                        >
                            Book Appointment
                        </a>
                        <a
                            href="#team"
                            className="px-6 sm:px-8 py-3 sm:py-4 rounded-full font-medium tracking-wide text-white border border-white/20 hover:bg-white/5 transition-colors duration-300 text-center text-sm sm:text-base"
                        >
                            View Barbers
                        </a>
                    </div>
